...
SRC_DIR = source
SRC_FILES = utils.c\
	vec2f/approx.c vec2f/construct.c vec2f/operators.c vec2f/common.c vec2f/common2.c vec2f/common3.c vec2f/specific.c\
	vec3f/approx.c vec3f/construct.c vec3f/operators.c vec3f/common.c vec3f/common2.c vec3f/common3.c\
